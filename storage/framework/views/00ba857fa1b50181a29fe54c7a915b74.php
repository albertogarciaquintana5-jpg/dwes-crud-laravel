                        ...
                        <div class="card-body text-center p-5">
                            ...
                            <?php if(Route::has('login')): ?>
                                <?php if(auth()->guard()->check()): ?>
                                    <a href="<?php echo e(url('/dashboard')); ?>" class="btn btn-lg btn-primary">Ir al Inicio</a>
                                <?php else: ?>
                                    <div class="d-grid gap-2">
                                        <a href="<?php echo e(route('login')); ?>" class="btn btn-lg btn-primary">🔐 Iniciar Sesión</a>
                                        <a href="<?php echo e(route('register')); ?>" class="btn btn-lg btn-success">✨ Registrarse</a>
                                    </div>
                                <?php endif; ?>
                            <?php endif; ?>
                        </div>
...
<?php /**PATH C:\xampp\htdocs\DAW_EJERCICIOS\DWES\2eva\Crud-laravel\resources\views/welcome.blade.php ENDPATH**/ ?>