<?php $__env->startSection('content'); ?>
    <div class="container my-5">
        ...
        <div class="mb-5 text-center">
            <h1 class="mb-2">¡Bienvenido, <?php echo e(Auth::user()->name); ?>! 🐾</h1>
            ...
            <div class="col-md-4">
                <div class="card text-center shadow-sm h-100 border-0 hover-effect">
                    <div class="card-body p-4">
                        ...
                        <a href="<?php echo e(route('pets.index')); ?>" class="btn btn-primary btn-sm mt-3">
            ...
            <div class="col-md-4">
                <div class="card text-center shadow-sm h-100 border-0 hover-effect">
                    <div class="card-body p-4">
                        ...
                        <a href="<?php echo e(route('pets.create')); ?>" class="btn btn-success btn-sm mt-3">
            ...
            <div class="col-md-4">
                <div class="card text-center shadow-sm h-100 border-0 hover-effect">
                    <div class="card-body p-4">
                        ...
                        <a href="<?php echo e(route('profile.edit')); ?>" class="btn btn-info btn-sm mt-3">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\DAW_EJERCICIOS\DWES\2eva\Crud-laravel\resources\views/dashboard.blade.php ENDPATH**/ ?>